...
const InvoiceSaleProductServiceTable: FC<InvoiceProductServicesTableProps> = (
  props
) => {
  const {
    getTableProps,
...
// * Main
const InvoiceTableSaleProductServicesMain: FC<{
  tableHeader: string;
  ...
  return (
    <Fragment>
      <Styles>
        <InvoiceSaleProductServiceTable
          columns={columns ?? []}
          data={props?.data ?? []}
        />
      </Styles>
...
export { InvoiceTableSaleProductServicesMain };
